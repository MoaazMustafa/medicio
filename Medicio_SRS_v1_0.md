...
**Software Requirements Specification** (Web Application)

**Document Version 1.0** — July 11, 2026
...
- [4. Functional Requirements & Detailed Module Specifications](#4-functional-requirements-detailed-module-specifications)
  - [M1 — Authentication & Access Control (IAM / RBAC)](#m1-authentication-access-control-iam-rbac)
  - [M2 — AI Symptom Checker & Recommendation Engine](#m2-ai-symptom-checker-recommendation-engine)
  - [M3 — Specialty AI Agents](#m3-specialty-ai-agents)
  - [M4 — Doctor Management](#m4-doctor-management)
  - [M5 — Hospital Management](#m5-hospital-management)
  - [M6 — Pharmacy Management](#m6-pharmacy-management)
  - [M7 — Lab Management](#m7-lab-management)
  - [M8 — Appointment Booking](#m8-appointment-booking)
  - [M9 — Medicine Tracker](#m9-medicine-tracker)
  - [M10 — Patient Portal & Health Records](#m10-patient-portal-health-records)
  - [M11 — Data Aggregation & Scraper Engine](#m11-data-aggregation-scraper-engine)
  - [M12 — Analytics, Logging & Monitoring](#m12-analytics-logging-monitoring)
...
- [8. Assumptions, Open Questions & Risks](#8-assumptions-open-questions-risks)
