...
export default function RegisterPage() {
  ...
  return (
    <section className="flex items-center justify-center min-h-[100vh] px-4 py-12">
            ...
            <div className="mt-2 flex flex-col gap-2">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs font-medium">
                <div
                  ...
                  className={`p-3 rounded-xl border cursor-pointer transition-all flex flex-col gap-1 select-none ${role === "PATIENT"
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`w-4 h-4 rounded-full border flex items-center justify-center ${role === "PATIENT"
                ...
                <div
                  ...
                  className={`p-3 rounded-xl border cursor-pointer transition-all flex flex-col gap-1 select-none ${role === "DOCTOR"
                    ? "border-primary bg-primary/10 text-text-primary ring-1 ring-primary"
                    : "border-border-custom bg-background-custom/30 text-text-secondary hover:border-primary/50"
                    }`}
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`w-4 h-4 rounded-full border flex items-center justify-center ${role === "DOCTOR"
                        ? "border-primary bg-primary text-white"
                        : "border-border-custom"
                        }`}
                    >
