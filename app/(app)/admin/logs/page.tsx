...
const MOCK_EMAIL_LOGS: EmailLogItem[] = [
  {
    id: "em-101",
    recipient: "moaazmustafa@gmail.com",
    subject: "Verify your Medicio account OTP",
    category: "OTP Verification",
    status: "DELIVERED",
    provider: "Resend SMTP",
    sentAt: "2026-07-30 22:10:15",
    bodyPreview: "Your Medicio verification code is 849201. This code will expire in 10 minutes. Do not share this code with anyone.",
    smtpHeader: "Message-ID: <849201.medicio@resend.dev> | TLS 1.3 Verified | 250 OK",
  },
  {
    id: "em-102",
    recipient: "doctor.sarah@medicio.com",
    subject: "Doctor Credential Approval Confirmation",
    category: "System Alert",
    status: "DELIVERED",
    provider: "Resend SMTP",
    sentAt: "2026-07-30 21:45:00",
    bodyPreview: "Dear Dr. Sarah, your medical practitioner credentials have been verified by the Medicio administration team.",
    smtpHeader: "Message-ID: <doc-appr.medicio@resend.dev> | TLS 1.3 Verified | 250 OK",
  },
  {
    id: "em-103",
    recipient: "patient.john@gmail.com",
    subject: "Upcoming Doctor Appointment Reminder",
    category: "Appointment Reminder",
    status: "DELIVERED",
    provider: "AWS SES",
    sentAt: "2026-07-30 20:30:12",
    bodyPreview: "Reminder: You have an upcoming consultation with Dr. Fleming scheduled for tomorrow at 10:00 AM.",
    smtpHeader: "Message-ID: <ses-appt-9912.aws.com> | TLS 1.3 Verified | 250 OK",
  },
  {
    id: "em-104",
    recipient: "admin@medicio.com",
    subject: "Security Alert: Password Reset Requested",
    category: "Password Reset",
    status: "DELIVERED",
    provider: "Resend SMTP",
    sentAt: "2026-07-30 19:15:40",
    bodyPreview: "A password reset request was initiated for your administrator account from IP address 192.168.1.10.",
    smtpHeader: "Message-ID: <sec-reset.medicio@resend.dev> | TLS 1.3 Verified | 250 OK",
  },
  {
    id: "em-105",
    recipient: "unverified.user@hotmail.com",
    subject: "Verify your Medicio account OTP",
    category: "OTP Verification",
    status: "FAILED",
    provider: "SendGrid",
    sentAt: "2026-07-30 18:50:00",
    bodyPreview: "Your Medicio verification code is 310948. Please enter this code to complete registration.",
    smtpHeader: "Message-ID: <sg-err-404.sendgrid.net> | 550 5.1.1 Mailbox does not exist",
  },
];
